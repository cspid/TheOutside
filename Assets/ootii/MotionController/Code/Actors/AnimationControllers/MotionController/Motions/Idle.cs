...
namespace com.ootii.Actors.AnimationControllers
{
    ...
    public class Idle : MotionControllerMotion
    {
        ...
        /// <summary>
        /// Don't use the old verification pattern
        /// </summary>
       ...
       /// <summary>
        ...
        public override void Update(float rDeltaTime, int rUpdateIndex)
        {
            ...
            {
                if (_ActionAlias.Length == 0 || mMotionController._InputSource == null || mMotionController._InputSource.IsPressed(_ActionAlias)) { mRotateWithCamera = true; }
            }
